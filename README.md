...
> Я AI-инженер, специализирующийся на построении интеллектуальных систем — от RAG-пайплайнов до production-готовых AI-агентов. Помогаю компаниям автоматизировать процессы с помощью LLM.
